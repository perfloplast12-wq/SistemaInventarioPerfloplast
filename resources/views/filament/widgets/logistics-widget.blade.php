    ...
    (function(){
        ...
        function init() {
            ...
            new ApexCharts(el, {
                ...
                xaxis: {
                    categories: names,
                    tickAmount: Math.min(maxT, 5),
                    labels: { style: { fontWeight: '700', fontSize: '11px', colors: isDark ? '#94a3b8' : '#64748b' }, formatter: function(v){ return isNaN(v) ? v : Math.round(v); } },
                    axisBorder: { show: false },
                    axisTicks: { show: false }
                },
                yaxis: { max: maxT + 1, labels: { formatter: function(v){ return isNaN(v) ? v : Math.round(v); }, style: { fontWeight: '800', colors: isDark ? '#64748b' : '#475569' } } },
                ...
                grid: { borderColor: gc, strokeDashArray: 0, xaxis: { lines: { show: false } }, yaxis: { lines: { show: false } } },
