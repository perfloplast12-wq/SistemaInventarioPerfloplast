...
<div class="pbi-wrap">
    ...
    <div class="pb-hdr" style="margin-bottom: 8px;">
        ...
        <div style="display:flex;gap:10px;">
            ...
            <a href="{{ $this->getMovementCreateUrl('in') }}" class="pb-btn" style="background:var(--pb-accent);color:#fff;border:none;display:flex;align-items:center;gap:6px;padding:6px 14px;border-radius:10px;font-size:12px;font-weight:900;text-decoration:none;box-shadow:0 4px 12px rgba(79,70,229,.2);">
        ...
        <div class="gc-4" style="display:flex;flex-direction:column;gap:16px;">
            ...
            <div>
                ...
                <div style="display:grid;grid-template-columns:1fr;gap:10px;">
                    @foreach([
                        ['t' => 'Gestión de Bodegas',   's' => 'Administrar almacenes y ubicaciones',  'u' => $this->getWarehousesUrl(),    'icon' => 'M13.5 21V16.5a1.5 1.5 0 011.5-1.5h3m-8.11 5.11a2 2 0 01-2.83 0l-5.66-5.66a2 2 0 010-2.83l5.66-5.66a2 2 0 012.83 0l5.66 5.66a2 2 0 010 2.83l-5.66 5.66z'],
                        ['t' => 'Registro de Insumos',   's' => 'Definir lo que se usa para producir',  'u' => $this->getRawMaterialsIndexUrl(),    'icon' => 'M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23-.693L5 14.5'],
                        ['t' => 'Registro de Productos', 's' => 'Definir los productos terminados',  'u' => $this->getFinishedProductsIndexUrl(),'icon' => 'M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9'],
                        ['t' => 'Unidades y Colores', 's' => 'Gestionar medidas y variantes',  'u' => $this->getUnitsUrl(),'icon' => 'M9.53 16.122a3 3 0 00-3.04 5.277 4.717 4.717 0 01.81-.68l5.7-4.025a4.711 4.711 0 01-3.47-0.572zM6.67 20.157a1.5 1.5 0 11.943-2.815 1.5 1.5 0 01-.943 2.815z M17.25 12c-1.729 0-3.29.702-4.418 1.838L12 15.008l-.832-1.17A6.242 6.242 0 006.75 12a6.25 6.25 0 00-6 6.25c0 3.452 2.798 6.25 6.25 6.25a6.242 6.242 0 004.418-1.838l.832 1.17.832-1.17A6.242 6.242 0 0017.25 24.5c3.452 0 6.25-2.798 6.25-6.25S20.702 12 17.25 12z'],
                        ['t' => 'Movimientos de Stock',   's' => 'Historial de lo que entra y sale',  'u' => $this->getKardexUrl(),               'icon' => 'M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z'],
                        ['t' => 'Retornos y Devoluciones', 's' => 'Ingresar productos devueltos',    'u' => $this->getReturnsUrl(),              'icon' => 'M9 15L3 9m0 0l6-6M3 9h12a6 6 0 010 12h-3'],
                    ] as $nav)
            ...
            <div>
                ...
                <div style="display:flex;flex-direction:column;gap:10px">
                    <a href="{{ $this->getMovementCreateUrl('adjust') }}" class="pb-card group" style="padding:14px;display:flex;align-items:center;justify-content:space-between;text-decoration:none;gap:14px;">
                        ...
                        <div style="flex:1">
                            <div style="font-size:13px;font-weight:900;color:var(--pb-text);line-height:1;transition:color .2s;" class="group-hover:text-amber-600">Nuevo Ajuste</div>
                            <div style="font-size:10px;font-weight:500;color:var(--pb-muted);margin-top:2px;">Corregir stock físico</div>
                        </div>
                    ...
                    <a href="{{ $this->getMovementCreateUrl('transfer') }}" class="pb-card group" style="padding:14px;display:flex;align-items:center;justify-content:space-between;text-decoration:none;gap:14px;">
                        ...
                        <div style="flex:1">
                            <div style="font-size:13px;font-weight:900;color:var(--pb-text);line-height:1;transition:color .2s;" class="group-hover:text-sky-600">Nuevo Traslado</div>
                            <div style="font-size:10px;font-weight:500;color:var(--pb-muted);margin-top:2px;">Cargar camiones o mover</div>
                        </div>
                            ...
                            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                                <div style="background:rgba(14,165,233,0.06);border-radius:10px;padding:12px 14px;border-left:3px solid #0ea5e9;">
                                    ...
                                    <div style="display:flex;align-items:baseline;gap:4px;">
                                        <span style="font-size:22px;font-weight:900;line-height:1;color:var(--pb-text);">{{ number_format($wh['raw_total'], 2) }}</span>
                                ...
                                <div style="background:rgba(16,185,129,0.06);border-radius:10px;padding:12px 14px;border-left:3px solid #10b981;">
                                    ...
                                    <div style="display:flex;align-items:baseline;gap:4px;">
                                        <span style="font-size:22px;font-weight:900;line-height:1;color:var(--pb-text);">{{ number_format($wh['finished_total'], 2) }}</span>
                            ...
                            <div style="display:flex;flex-direction:column;gap:8px;">
                                ...
                                <div style="display:flex;flex-direction:column;gap:5px;margin-top:2px;">
                                    <div style="display:flex;justify-content:space-between;align-items:baseline;">
                                        ...
                                        <span style="font-size:12px;font-weight:900;color:var(--pb-text);">{{ number_format($itm['qty'], 2) }} <span style="font-size:10px;font-weight:600;color:var(--pb-muted);">{{ $itm['unit'] }}</span></span>
                                    </div>
