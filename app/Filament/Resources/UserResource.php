            ...
            Forms\Components\Section::make('Contraseña')
                ->schema([
                    Forms\Components\TextInput::make('password')
                        ...
                        ->password()
                        ->revealable()
                        ->helperText('Si se deja vacío al editar, se mantendrá la contraseña actual. No es posible ver la contraseña anterior porque el sistema la cifra por seguridad.')
