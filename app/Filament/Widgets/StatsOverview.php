...
class StatsOverview extends BaseWidget
{
    ...
    protected static ?string $pollingInterval = '120s'; // Aumentado para reducir carga
    ...
    protected function getStats(): array
    {
        ...
        // Cachear los resultados por 5 minutos para evitar consultas constantes
        return Cache::remember('dashboard_stats_overview', 300, function () {
