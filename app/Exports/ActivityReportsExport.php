...
class ActivityReportsExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithDrawings, ShouldAutoSize, WithCustomStartCell
{
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->setCellValue('C2', "REPORTE DE ACTIVIDADES SEMANALES");
